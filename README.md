...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-doxxb4k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-doxxb4k.containers.anotherwebservice.com/
...
```
git clone git@github.com:vitorcedrim/container-doxxb4k.git
cd container-doxxb4k
```
...
```
docker attach container-doxxb4k
```
